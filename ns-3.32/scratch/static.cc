...
// Problem: No static route introducing 10.0.1.4 (Rpi) to simulated nodes.
  ...
  Ptr<Ipv4StaticRouting> staticRoute = staticRouting.GetStaticRouting(nodes.Get(1)->GetObject<Ipv4>());
  staticRoute->AddHostRouteTo(Ipv4Address("10.0.1.4"), interfaces.GetAddress(0), 1, 0);

  Ipv4StaticRoutingHelper staticRouting1;
  Ptr<Ipv4StaticRouting> staticRoute1 = staticRouting1.GetStaticRouting(nodes.Get(2)->GetObject<Ipv4>());
  staticRoute1->AddHostRouteTo(Ipv4Address("10.0.1.4"), interfaces.GetAddress(0), 1, 0);

  Ipv4StaticRoutingHelper staticRouting2;
  Ptr<Ipv4StaticRouting> staticRoute2 = staticRouting2.GetStaticRouting(nodes.Get(3)->GetObject<Ipv4>());
  staticRoute2->AddHostRouteTo(Ipv4Address("10.0.1.4"), interfaces.GetAddress(0), 1, 0);

  Ipv4StaticRoutingHelper staticRouting3;
  Ptr<Ipv4StaticRouting> staticRoute3 = staticRouting3.GetStaticRouting(nodes.Get(4)->GetObject<Ipv4>());
  staticRoute3->AddHostRouteTo(Ipv4Address("10.0.1.4"), interfaces.GetAddress(0), 1, 0);

  Ipv4StaticRoutingHelper staticRouting4;
  Ptr<Ipv4StaticRouting> staticRoute4 = staticRouting4.GetStaticRouting(nodes.Get(5)->GetObject<Ipv4>());
  staticRoute4->AddHostRouteTo(Ipv4Address("10.0.1.4"), interfaces.GetAddress(0), 1, 0);

  Ipv4StaticRoutingHelper staticRouting5;
  Ptr<Ipv4StaticRouting> staticRoute5 = staticRouting5.GetStaticRouting(nodes.Get(6)->GetObject<Ipv4>());
  staticRoute5->AddHostRouteTo(Ipv4Address("10.0.1.4"), interfaces.GetAddress(0), 1, 0);
