...
int blahh=0;
std::ofstream outfile ("aodv_energy_output_mal.txt");
std::ofstream outfile2 ("benign_P1.csv");
...
int main (int argc, char *argv[])
{
  ...
  malaodv.Set("IsMalicious",BooleanValue(false));
  ...
  // Ptr<Ipv4StaticRouting> staticRoute5 = staticRouting5.GetStaticRouting(c.Get(5)->GetObject<Ipv4>());
  // staticRoute5->AddHostRouteTo(interfaces.GetAddress(0), interfaces.GetAddress(3), 1, 0);

  // Ipv4StaticRoutingHelper staticRouting1;
  // Ptr<Ipv4StaticRouting> staticRoute1 = staticRouting1.GetStaticRouting(c.Get(1)->GetObject<Ipv4>());
  // staticRoute1->AddHostRouteTo(interfaces.GetAddress(3), interfaces.GetAddress(2), 1, 0);

  // Ipv4StaticRoutingHelper staticRouting2;
  // Ptr<Ipv4StaticRouting> staticRoute2 = staticRouting2.GetStaticRouting(c.Get(1)->GetObject<Ipv4>());
  // staticRoute2->AddHostRouteTo(interfaces.GetAddress(4), interfaces.GetAddress(2), 1, 0);

  // Ipv4StaticRoutingHelper staticRouting3;
  // Ptr<Ipv4StaticRouting> staticRoute3 = staticRouting3.GetStaticRouting(c.Get(5)->GetObject<Ipv4>());
  // staticRoute3->AddHostRouteTo(interfaces.GetAddress(3), interfaces.GetAddress(2), 1, 0);

  // Ipv4StaticRoutingHelper staticRouting4;
  // Ptr<Ipv4StaticRouting> staticRoute4 = staticRouting4.GetStaticRouting(c.Get(5)->GetObject<Ipv4>());
  // staticRoute4->AddHostRouteTo(interfaces.GetAddress(4), interfaces.GetAddress(2), 1, 0);

  // Ipv4StaticRoutingHelper staticRouting6;
  // Ptr<Ipv4StaticRouting> staticRoute6 = staticRouting6.GetStaticRouting(c.Get(4)->GetObject<Ipv4>());
  // staticRoute6->AddHostRouteTo(interfaces.GetAddress(5), interfaces.GetAddress(2), 1, 0);

  // Ipv4StaticRoutingHelper staticRouting7;
  // Ptr<Ipv4StaticRouting> staticRoute7 = staticRouting7.GetStaticRouting(c.Get(3)->GetObject<Ipv4>());
  // staticRoute7->AddHostRouteTo(interfaces.GetAddress(5), interfaces.GetAddress(2), 1, 0);

  // Ipv4StaticRoutingHelper staticRouting8;
  // Ptr<Ipv4StaticRouting> staticRoute8 = staticRouting8.GetStaticRouting(c.Get(0)->GetObject<Ipv4>());
  // staticRoute8->AddHostRouteTo(interfaces.GetAddress(3), interfaces.GetAddress(2), 1, 0);
  ...
  if (tracing == true)
    {
      ...
      wifiPhy.EnablePcap ("aodv_trustflow_mal", devices);
