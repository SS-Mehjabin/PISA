...
main (int argc, char *argv[])
{
  ...
  // ghost node.
  //
  tapBridge.SetAttribute ("DeviceName", StringValue ("tap-d1"));
  tapBridge.Install (nodes.Get (1), devices.Get (1));

  tapBridge.SetAttribute ("DeviceName", StringValue ("tap-d2"));
  tapBridge.Install (nodes.Get (2), devices.Get (2));

  //tapBridge.SetAttribute ("DeviceName", StringValue ("tap-d3"));
