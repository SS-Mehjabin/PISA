...
main (int argc, char *argv[])
{
  ...
  basicSourceHelper.Set ("BasicEnergySourceInitialEnergyJ", DoubleValue (100.1));
  // install source
  ...
  wifiPhy.EnableAsciiAll (ascii.CreateFileStream ("blah.tr"));
  wifiPhy.EnablePcap ("blah", devices);
