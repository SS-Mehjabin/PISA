...
int main (int argc, char *argv[])
{
  ...
  if (tracing == true)
    {
      ...
      wifiPhy.EnableAsciiAll (ascii.CreateFileStream ("wifi-simple-adhoc-grid1.tr"));
  ...
  Simulator::Schedule (Seconds (70.0), &GenerateTraffic,
                       source2, packetSize, 10000, Seconds(0.001));
  ...
  Simulator::Schedule (Seconds (97.0), &GenerateTraffic,
