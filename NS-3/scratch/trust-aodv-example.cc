...
AodvExample::CreateDevices ()
{
  ...
  if (pcap)
    {
      wifiPhy.EnablePcapAll (std::string ("aodv_ns3_test"));
    }
}
  ...
  if (printRoutes)
    {
      ...
      Ptr<OutputStreamWrapper> trustRoutingStream = Create<OutputStreamWrapper> ("Normaltrust-aodv_trust_table_at_55.routes", std::ios::out);
      ...
      Ptr<OutputStreamWrapper> trustRoutingStream3 = Create<OutputStreamWrapper> ("Normaltrust-aodv_trust_table_at_75.routes", std::ios::out);
